 ...
 *
 */
class UserShareMoneyIntegral extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%user_share_money_integral}}';
    }
    ...
    {
        $model = UserShareMoneyIntegral::findOne([
            'store_id'=>$store_id,
            'user_id'=>$user_id,
            'order_id'=>$order_id,
//            'type'=>0,
        ...
        $model = new UserShareMoneyIntegral();
