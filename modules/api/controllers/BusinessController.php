...
class BusinessController extends Controller
{
    ...
    //积分兑换欢乐豆
    public function actionJfToHld()
    {
        $form = new BusinessCommentForm();
        $form->attributes = \Yii::$app->request->post();
        $form->store_id = $this->store->id;
        $form->user_id = \Yii::$app->user->id;
        $this->renderJson($form->JfToHld());
    }


    //积分兑换欢乐豆
    public function actionFairHldExchange()
    {
        $form = new BusinessCommentForm();
        $form->attributes = \Yii::$app->request->post();
        $form->store_id = $this->store->id;
    ...
    //计算预计收益积分兑换欢乐豆
    public function actionPreFairHldExchange()
    {
        $form = new BusinessCommentForm();
        $form->attributes = \Yii::$app->request->post();
        $form->store_id = $this->store->id;
        $form->user_id = \Yii::$app->user->id;
        $this->renderJson($form->PreJfToHld());
    }
