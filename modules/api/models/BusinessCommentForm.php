...
//      合计收益
        ...
        if($this->is_hg){
            ...
            , '4' => '欢乐豆出，暴击红包：点我给智能机主人自动发红包咯，我是智能鲜蜂服务点来的?！'
            , '4' => '欢乐豆出，暴击红包：智能机自动绑定主人哦，坐着也收钱?！！'
            , '5' => '欢乐豆出，暴击红包：谁说公"机"不生蛋没有生蛋，我生金蛋！！'
            , '6' => '欢乐豆出，暴击红包：我是智能鲜蜂服务点来的？难得我开心，不和你"机"较'
        ...
        if($this->is_zhibo){
            ...
            , '14' => '直播券：想办法进直播室找我吧！！'
            , '15' => '直播券：快进帅哥哥在直播啦！！'
            , '16' => '直播券：快进来，可以预约订阅看直播哦！！'
            , '17' => '直播券：抢红包，看直播，是个奇迹真爽！'
            , '18' => '直播券：抢红包，看直播，听说腾讯又要升级券池了！'
            );
...
//        $user->coupon_total = $user->coupon_total - $order->num;
    ...
    public function getBusinessSetting()
    {
        ...
        if (!in_array($this->time, $open_time)) {
            if($this->is_hg){
                return false;//如果是智能鲜蜂服务点来源不需要验证
            }
            return '集市未到开放时间';
        }
