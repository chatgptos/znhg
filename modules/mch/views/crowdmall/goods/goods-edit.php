...
if (!$returnUrl)
    $returnUrl = $urlManager->createUrl(['mch/crowdmall/goods/goods']);
?>
...
<!--                                            </td>-->
                                            <td>
                                                <input class="form-control form-control-sm" type="number" min="0"
                                                       step="0.01" style="width: 70px"
                                                       v-bind:name="'attr['+index+'][coupon]'"
                                                       v-bind:value="item.coupon">
                                            </td>
                                            <td>
...
<script>
    ...
    function getSubCatList() {
        ...
        page.sub_cat_list = [];
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/crowdmall/goods/get-cat-list'])?>",
            data: {
                parent_id: parent_id,
            },
...
//        var url = $('.copy-url').val();
        ...
        $.myLoading();
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/crowdmall/goods/copy'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                url: url,
