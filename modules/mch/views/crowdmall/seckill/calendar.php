...
<div class="panel mb-3">
    <div class="panel-header">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['mch/crowdmall/seckill/goods']) ?>">按商品查看</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= $urlManager->createUrl(['mch/crowdmall/seckill/calendar']) ?>">按日历查看</a>
            </li>
        </ul>
...
<script>
    ...
    function seckillBoxClick(e) {
        ...
        $.ajax({
            url: '<?= $urlManager->createUrl(["mch/crowdmall/seckill/date"])?>',
            data: {
                date: e.dataset.date,
            },
            dataType: "json",
