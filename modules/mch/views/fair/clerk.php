        ...
        <table class="table table-bordered bg-white">
            ...
            <?php foreach ($list as $u): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= $urlManager->createUrl(['mch/fair/card', 'clerk_id' => $u['id']]) ?>"><?= $u['card_count'] ?></a>
                    </td>
                    <td>
                        <?php if ($u['is_clerk'] == 0): ?>
                            <a class="btn btn-sm btn-primary del" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['mch/fair/clerk-edit', 'id' => $u['id'], 'status' => 1]) ?>"
                               data-content="是否设为核销员？">设为核销员</a>
                        <?php else: ?>
                            <a class="btn btn-sm btn-danger del" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['mch/fair/clerk-edit', 'id' => $u['id'], 'status' => 0]) ?>"
                                        ...
                                        <tr v-for="(item,index) in show_user_list">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm send" href="javascript:"
                                                   data-url="<?= $urlManager->createUrl(['mch/fair/clerk-edit', 'status' => 1]) ?>"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary send" href="javascript:"
                               data-url="<?= $urlManager->createUrl(['mch/fair/clerk-edit', 'status' => 1, 'edit' => 1]) ?>"
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            showKeyword: function () {
                ...
                $.ajax({
                    url: '<?=$urlManager->createUrl(['mch/fair/get-user'])?>',
                    dataType: 'json',
                    type: 'get',
                    data: {
                        keyword: keyword
