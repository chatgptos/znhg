        ...
        <table class="table table-bordered bg-white">
            ...
            <?php foreach ($list as $u): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-link"
                           href="<?= $urlManager->createUrl(['mch/fair/coupon', 'user_id' => $u['id']]) ?>"><?= User::getCouponcount($u['id']) ?></a>
                    </td>
                    <td>
                        <a class="btn btn-sm btn-link"
                           href="<?= $urlManager->createUrl(['mch/fair/card', 'user_id' => $u['id']]) ?>"><?= User::getCardCount($u['id']) ?></a>
                    </td>
                    <td>
                        <a class="btn btn-sm btn-link"
                           href="<?= $urlManager->createUrl(['mch/fair/rechange-log', 'user_id' => $u['id']]) ?>"><?= $u['integral'] ?></a>
                    </td>
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['mch/fair/edit', 'id' => $u['id']]) ?>">编辑</a>
                ...
                <td>
                    <a class="btn btn-sm btn-danger del" href="javascript:"
                       data-url="<?= $urlManager->createUrl(['mch/fair/del', 'id' => $u['id']]) ?>"
