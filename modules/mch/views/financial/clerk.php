                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-3 text-right">
                                    <label class="col-form-label required">购值爽服务点选择</label>
                                </div>
                                <div class="col-9">
                                    ...
                                    <template v-else>
                                        <label class="col-form-label">暂未设置购值爽服务点，<a
...
<script>
    ...
    $(document).on('click', '.send', function () {
        ...
        if (app.select_shop == "") {
            $('.shop-error').prop('hidden', false).html('请先选择购值爽服务点');
            return;
        }
        $.ajax({
            url: a.data('url'),
