            ...
            <div class="form-title" style="border: 0;">
                <nav class="nav nav-tabs" id="myTab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-level-edit" data-toggle="tab" href="#level-edit"
                       role="tab"
                       aria-controls="level-edit" aria-selected="true">奖品等级设置</a>
                    <a class="nav-item nav-link" id="nav-content-edit" data-toggle="tab" href="#content-edit" role="tab"
                       aria-controls="content-edit" aria-selected="false">奖品等级说明</a>
                </nav>
            ...
            <div class="tab-content mt-4" id="nav-tabContent">
                <div class="tab-pane fade show active" id="level-edit" role="tabpanel" aria-labelledby="nav-level-edit">
                    ...
                    <form method="post" class="auto-form" autocomplete="off"
                          return="<?= $urlManager->createUrl(['mch/choujiang/level']) ?>">
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                <div class="offset-2 col-5">
                                    <div class="text-muted fs-sm text-danger">奖品满足条件等级</div>
                                    <div class="text-muted fs-sm text-danger">如需个别调整，请前往<a
                                            href="<?= $urlManager->createUrl(['mch/choujiang/index']) ?>">奖品列表</a>调整
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">奖品等级名称</label>
                                </div>
                                <div class="col-5">
                            ...
                            <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">抽奖条件（花费）</label>
                                </div>
                                <div class="col-5">
                                    <div class="input-group">
                                        <span class="input-group-addon bg-white">几张券抽一次</span>
                                        <input class="form-control" name="money" type="number"
                                               value="<?= $level->money ?>">
                                        <span class="input-group-addon bg-white">张</span>
                                    </div>
                                    <div class="text-muted fs-sm">抽奖条件（以最小奖品为主）</div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">奖励张数</label>
                                </div>
                                <div class="col-5">
                                    <div class="input-group">
                                        <input class="form-control" name="discount" value="<?= $level->discount ?>">
                                        <span class="input-group-addon bg-white">张数</span>
                                    </div>
                                    <div class="text-muted fs-sm">请输入1~10之间的数字</div>
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">该奖品概率</label>
                            ...
                            <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">转的圈数</label>
                                </div>
                                <div class="col-5">
                                    <div class="input-group">
                                        <input class="form-control" name="quan" value="<?= $level->quan ?>">
                                        <span class="input-group-addon bg-white">券</span>
                                    </div>
                                    <div class="text-muted fs-sm">请输入1~10之间的数字</div>
                                </div>
                            </div>
                        ...
                        <div class="form-body">
                            <div class="form-group row">
                                <div class="col-2 text-right required">
                                    <label class="col-form-label required">奖品等级说明</label>
                                </div>
                                <div class="col-5">
