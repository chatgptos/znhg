        ...
        <form class="form auto-form" method="post" autocomplete="off" data-return="<?= $returnUrl ?>">
            <div class="head">
                <div class="head-content" flex="dir:left">
                    ...
                    <a flex="cross:center" class="head-step" href="#step4">奖金详情</a>
                </div>
            </div>
            <div id="app">
                    ...
                    <div>
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label required">奖金分类</label>
                            </div>
                            <div class="col-9">
                ...
                <div class="step-block" flex="dir:left box:first">
                    ...
                    <div>
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label required">奖金名称</label>
                            </div>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label">奖金排序</label>
                            </div>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class="col-form-label required">奖金缩略图</label>
                            </div>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class="col-form-label required">奖金图片</label>
                            </div>
                            <div class="col-9">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label required">奖金金额</label>
                            </div>
                            <div class="col-9">
                                <div class="input-group short-row">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label required">奖金券数量</label>
                            </div>
                            <div class="col-9">
                                <div class="input-group short-row">
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label">支持智能鲜蜂服务点</label>
                            </div>
                            <div class="col-9">
                                <input class="form-control short-row" name="model[shop_id]"
                                       value="<?= $goods['shop_id'] ?>">
                                <div class="fs-sm text-muted">请填写智能鲜蜂服务点id 多个请使用英文逗号<kbd>,</kbd>分隔，不使用智能鲜蜂服务点请填 -1</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step-block" flex="dir:left box:first">
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            <div class="col-3 text-right">
                                <label class=" col-form-label required">奖金券</label>
                            </div>
                            <div class="col-9">
                                <div class="input-group short-row">
                                    <input type="number" step="1" class="form-control"
