        ...
        <div class="mb-3 clearfix">
            <div class="p-4 bg-shaixuan">
                <form method="get">
                    ...
                    <div flex="dir:left">
                        <div class="mr-4">
                            <div class="form-settlementstatistics row w-20">
                                <div class="col-5">
                    ...
                    <div flex="dir:left">
                        <div class="mr-4">
                            <div class="form-settlementstatistics">
            ...
            <ul class="nav nav-tabs status">
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == -1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'])) ?>">全部</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 0 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 0])) ?>">未付款</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 1])) ?>">待发货</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 2 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 2])) ?>">已发货</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 6 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 6])) ?>">拼团中</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 3 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 3])) ?>">已完成</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 5 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/settlementstatistics/order/index'], $condition, ['status' => 5])) ?>">已取消</a>
                </li>
            </ul>
        </div>
                ...
                <table class="table table-bordered bg-white">
                    <tr>
                        <td colspan="5">
                            ...
                            <?php if ($order_item['parent_id'] == 0 && $order_item['is_settlementstatistics'] == 1): ?>
                                <span class="mr-5">
                    ...
                    <tr>
                                    ...
                                    <div class="fs-sm">
                                        ...
                                        <?php $attr_list = json_decode($order_item['attr']); ?>
                                            <?php if (is_array($attr_list)):foreach ($attr_list as $attr): ?>
                                                <span class="mr-3"><?= $attr->attr_settlementstatistics_name ?>
                                                    :<?= $attr->attr_name ?></span>
                        ...
                        <td class="order-tab-2">
                            ...
                            <?php if ($order_item['colonel'] && $order_item['parent_id'] == 0 && $order_item['is_settlementstatistics'] == 1): ?>
                    ...
                    <div class="modal-body">
                        <form class="send-form" method="post">
                            ...
                            <div class="is-true-express">
                                ...
                                <label>快递公司</label>
                                <div class="input-settlementstatistics mb-3">
                                    <input class="form-control" placeholder="请输入快递公司" type="text" autocomplete="off"
                                           name="express">
                                    <div class="input-settlementstatistics-btn">
...
<script>
    ...
    $(document).on("click", ".send-confirm-btn", function () {
        ...
        console.log(error);
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/settlementstatistics/order/send'])?>",
            type: "post",
...
<script>
    ...
    $(document).on('click', '.print', function () {
        ...
        $.ajax({
            url: "<?=$urlManager->createAbsoluteUrl(['mch/settlementstatistics/order/print'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                id: id,
