...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="form auto-form" method="post" autocomplete="off"
              return="<?= $urlManager->createUrl(['mch/settlementstatistics/pt/banner']) ?>">
            <div class="form-body">
                ...
                <div class="form-settlementstatistics row">
                    ...
                    <div class="col-9">
                        <div class="input-settlementstatistics page-link-input">
                ...
                <div class="form-settlementstatistics row">
                    ...
                    <div class="col-9">
                        <div class="upload-settlementstatistics">
