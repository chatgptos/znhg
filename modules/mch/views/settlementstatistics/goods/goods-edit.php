...
if (!$returnUrl)
    $returnUrl = $urlManager->createUrl(['mch/settlementstatistics/goods/index']);
?>
...
<style>
    ...
    .attr-settlementstatistics-delete {
    ...
    .attr-settlementstatistics-delete:hover {
        background: #ff4544;
        color: #fff;
    ...
    form .form-settlementstatistics .col-3 {
        -webkit-box-flex: 0;
    ...
    <div class="panel-body">
        ...
        <form class="form auto-form" method="post" autocomplete="off" data-return="<?= $returnUrl ?>">
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-settlementstatistics row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">商品分类</label>
                        </div>
                        <div class="col-9">
                            <div class="input-settlementstatistics short-row">
                ...
                <div>
                    ...
                    <div class="form-settlementstatistics row">
                        ...
                        <div class="col-9">
                            <div class="input-settlementstatistics short-row">
                                ...
                                <span class="input-settlementstatistics-addon">克<span>
                            </div>
                        </div>
                    </div>
                    <div class="form-settlementstatistics row">
                        ...
                        <div class="col-9">
                            <div class="upload-settlementstatistics short-row">
                    ...
                    <div class="form-settlementstatistics row">
                        ...
                        <div class="col-9">
                            ...
                            <div class="upload-settlementstatistics multiple short-row">
                                <div class="input-settlementstatistics">
                    ...
                    <div class="form-settlementstatistics row">
                        ...
                        <div class="col-9">
                            <div class="input-settlementstatistics short-row">
                                ...
                                <span class="input-settlementstatistics-addon">元</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-settlementstatistics row">
                        ...
                        <div class="col-9">
                            <input type="number" step="1" class="form-control short-row"
                                   name="model[settlementstatistics_num]" min="2"
                                   value="<?= $goods['settlementstatistics_num'] ? $goods['settlementstatistics_num'] : 2 ?>">
                        ...
                        <div class="col-9">
                            <div class="input-settlementstatistics short-row">
                                <input type="number" step="1" class="form-control"
                                       name="model[settlementstatisticstime]" min="1"
                                       value="<?= $goods['settlementstatisticstime'] ? $goods['settlementstatisticstime'] : 1 ?>">
                                <span class="input-settlementstatistics-addon">时</span>
                        ...
                        <div class="form-settlementstatistics row">
                            ...
                            <div class="col-9">
                                <div>请前往商品库存设置库存和价格，<a target="_blank"
                                                       href="<?= $urlManager->createUrl(['mch/settlementstatistics/goods/goods-attr', 'id' => $goods['id']]) ?>">立即前往</a>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="form-settlementstatistics row">
                            ...
                            <div class="col-9">
                                <div class="input-settlementstatistics short-row mb-2" v-if="attr_settlementstatistics_list.length<3">
                                    <span class="input-settlementstatistics-addon">规格组</span>
                                    <input class="form-control add-attr-settlementstatistics-input" placeholder="如颜色、尺码、套餐">
                                    <span class="input-settlementstatistics-btn">
                                    <a class="btn btn-secondary add-attr-settlementstatistics-btn" href="javascript:">添加</a>
                                </span>
                                </div>
                                <div v-else class="mb-2">最多只可添加3个规格组</div>
                                <div v-for="(attr_settlementstatistics,i) in attr_settlementstatistics_list" class="attr-settlementstatistics">
                                    <div>
                                        <b>{{attr_settlementstatistics.attr_settlementstatistics_name}}</b>
                                        <a v-bind:index="i" href="javascript:" class="attr-settlementstatistics-delete">×</a>
                                    </div>
                                    <div class="attr-list">
                                        <div v-for="(attr,j) in attr_settlementstatistics.attr_list" class="attr-item">
                                            <span class="attr-name">{{attr.attr_name}}</span>
                                            <a v-bind:settlementstatistics-index="i" v-bind:index="j" class="attr-delete"
                                               href="javascript:">×</a>
                                        </div>
                                        <div style="display: inline-block;width: 200px;margin-top: .5rem">
                                            <div class="input-settlementstatistics attr-input-settlementstatistics" style="border-radius: 0">
                                            <span class="input-settlementstatistics-addon"
                        ...
                        <div class="form-settlementstatistics row">
                            ...
                            <div class="col-9">
                                <div v-if="attr_settlementstatistics_list && attr_settlementstatistics_list.length>0">
                                    <table class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th v-for="(attr_settlementstatistics,i) in attr_settlementstatistics_list"
                                                v-if="attr_settlementstatistics.attr_list && attr_settlementstatistics.attr_list.length>0">
                                                {{attr_settlementstatistics.attr_settlementstatistics_name}}
                                            </th>
                                            <th>库存</th>
                                            <th>价格(0表示保持原售价)</th>
                                            <th>货号</th>
                                        ...
                                        <tr v-for="(item,index) in checked_attr_list">
                                            <td v-for="(attr,attr_index) in item.attr_list">
                                                ...
                                                <input type="hidden" style="width: 40px"
                                                       v-bind:name="'attr['+index+'][attr_list]['+attr_index+'][attr_settlementstatistics_name]'"
                                                       v-bind:value="attr.attr_settlementstatistics_name">
...
<script>
    ...
    var page = new Vue({
        ...
        data: {
            sub_cat_list: [],
            attr_settlementstatistics_list: [],
            check_attr_list: [],
        }
    });
    ...
    $(document).on("click", ".add-attr-settlementstatistics-btn", function () {
        var name = $(".add-attr-settlementstatistics-input").val();
        name = $.trim(name);
        if (name == "")
            return;
        page.attr_settlementstatistics_list.push({
            attr_settlementstatistics_name: name,
            attr_list: [],
        });
        $(".add-attr-settlementstatistics-input").val("");
        page.checked_attr_list = getAttrList();
    });

    $(document).on("click", ".add-attr-btn", function () {
        var name = $(this).parents(".attr-input-settlementstatistics").find(".add-attr-input").val();
        var index = $(this).attr("index");
        name = $.trim(name);
        if (name == "")
            return;
        page.attr_settlementstatistics_list[index].attr_list.push({
            attr_name: name,
        });
        $(this).parents(".attr-input-settlementstatistics").find(".add-attr-input").val("");
        page.checked_attr_list = getAttrList();
    });


    $(document).on("click", ".attr-settlementstatistics-delete", function () {
        var index = $(this).attr("index");
        page.attr_settlementstatistics_list.splice(index, 1);
        page.checked_attr_list = getAttrList();
    });

    $(document).on("click", ".attr-delete", function () {
        var index = $(this).attr("index");
        var settlementstatistics_index = $(this).attr("settlementstatistics-index");
        page.attr_settlementstatistics_list[settlementstatistics_index].attr_list.splice(index, 1);
        page.checked_attr_list = getAttrList();
    });
    ...
    function getAttrList() {
        var array = [];
        for (var i in page.attr_settlementstatistics_list) {
            for (var j in page.attr_settlementstatistics_list[i].attr_list) {
                var object = {
                    attr_settlementstatistics_name: page.attr_settlementstatistics_list[i].attr_settlementstatistics_name,
                    attr_id: null,
                    attr_name: page.attr_settlementstatistics_list[i].attr_list[j].attr_name,
                };
                if (!array[i])
                    array[i] = [];
                array[i].push(object);
...
<script>
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    page.attr_settlementstatistics_list = res.data.attr_settlementstatistics_list;
    ...
    $(document).on('click', '.mall-copy-btn', function () {
        ...
        $.myLoading();
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/settlementstatistics/goods/copy'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                mall_id: mall_id,
