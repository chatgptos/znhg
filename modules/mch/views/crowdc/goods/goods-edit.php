...
if (!$returnUrl)
    $returnUrl = $urlManager->createUrl(['mch/crowdc/goods/goods']);
?>
...
<script>
    ...
    function getSubCatList() {
        ...
        page.sub_cat_list = [];
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/crowdc/goods/get-cat-list'])?>",
            data: {
                parent_id: parent_id,
            },
...
//        var url = $('.copy-url').val();
        ...
        $.myLoading();
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/crowdc/goods/copy'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                url: url,
