...
<div class="panel mb-3">
    <div class="panel-header">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['mch/crowdc/seckill/goods']) ?>">按商品查看</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= $urlManager->createUrl(['mch/crowdc/seckill/calendar']) ?>">按日历查看</a>
            </li>
        </ul>
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['mch/crowdc/seckill/goods-edit']) ?>">添加众筹整点商品</a>
            </li>
        </ul>
    </div>
            ...
            $('.seckill-calendar-box td.xdsoft_date').each(function () {
                ...
                if (seckill) {
                    html = '<div class="seckill-box pointer" onclick="seckillBoxClick(this)" data-date=' + seckill.open_date + '>' +
                        ...
                        '<div class="has-seckill">' + seckill.seckill_count + '条众筹安排</div>' +
                        '</div>';
                } else {
                    html = '<div class="seckill-box">' +
                        '<div class="seckill-date">' + parseInt(d) + '</div>' +
                        '<div class="no-seckill">暂无众筹</div>' +
                        '</div>';
                }
                $(this).html(html);
            });
