...
<div class="panel mb-3" id="sender">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post" return="<?= $urlManager->createUrl(['mch/cert/express']) ?>">
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">选择商标</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">品名</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="model[customer_name]"
                           value="<?= $list['customer_name'] ?>">
                    <div class="text-muted fs-sm">与厂商申请</div>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">颜色</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">尺码</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">成份</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">产品等级</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">执行标准 </label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">安全类别</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">产地地区</label>
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">零售价</label>
                </div>
                <div class="col-sm-6">
