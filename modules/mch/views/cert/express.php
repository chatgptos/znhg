...
<div class="panel mb-3">
    <div class="panel-header">
        ...
        <ul class="nav nav-right">
            <li class="nav-item">
                <a class="nav-link" href="<?= $urlManager->createUrl(['mch/cert/express-edit']) ?>">添加合格证设置项</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="javascript:" data-toggle="modal" data-target="#sender">设置操作员工信息</a>
            </li>
            <li class="nav-item">
        ...
        <table class="table table-bordered bg-white">
            ...
            <?php foreach ($list as $index => $value): ?>
                <tr>
                    ...
                    <td>
                        <div>产品等级：<?= $value['sender_name'] ?></div>
                        <div>执行标准：<?= $value['sender_tel'] ? $value['sender_tel'] : $value['sender_mobile'] ?></div>
                        <div>
                            产地：<?= $value['sender_province'] . $value['sender_city'] . $value['sender_area'] . $value['sender_address'] ?></div>
                    </td>
                    <td>
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['mch/cert/express-edit', 'id' => $value['id']]) ?>">修改</a>

                        <a class="del btn btn-sm btn-danger" href="javascript:"
                           data-content="是否删除？"
                           data-url="<?= $urlManager->createUrl(['mch/cert/express-del', 'id' => $value['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class=" auto-submit-form" method="post" autocomplete="off"
                      data-return="<?= $urlManager->createUrl(['mch/cert/express']) ?>">
