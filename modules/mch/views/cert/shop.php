...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <div class="float-left pt-2 mb-4">
            <a class="btn btn-primary edit-modal" href="<?= $urlManager->createUrl(['mch/cert/shop-edit']) ?>">添加门店</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm"
                           href="<?= $urlManager->createUrl(['mch/cert/shop-edit', 'id' => $item['id']]) ?>">修改</a>
                        <a class="btn btn-danger btn-sm del" href="javascript:"
                           data-url="<?= $urlManager->createUrl(['mch/cert/shop-del', 'id' => $item['id']]) ?>"
