...
class AwardListFuliForm extends Model
{
    public $store_id;
    ...
    public function search()
    {
        ...
        $query = AwardFuli::find()->where(['store_id'=>$this->store_id,'is_delete'=>0]);
    ...
    public function searchName()
    {
        ...
        $list = AwardFuli::find()->where(['store_id'=>$this->store_id,'is_delete'=>0,'status'=>1])->orderBy(['level'=>SORT_ASC])->asArray()->all();
