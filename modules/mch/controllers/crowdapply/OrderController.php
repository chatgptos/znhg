...
use app\modules\mch\models\crowdapply\Order;
use app\modules\mch\models\crowdapply\OrderClerkForm;
use app\modules\mch\models\crowdapply\OrderForm;
use app\modules\mch\models\crowdapply\OrderSendForm;
...
class OrderController extends Controller
{
    ...
    public function actionClerk()
    {
        ...
        $form->price = \Yii::$app->request->get('type');
        $form->store_id = $this->store->id;
        $this->renderJson($form->save());
    }
